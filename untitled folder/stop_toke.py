...
import nltk
# nltk.download() # remove if this you don't have NLTK corpora, models already
...
# open file. I used | as a seperator -- This uses the poorly labled columns
df = pd.read_csv('../data/step2.csv', sep='|')
print("File open. Removing puncuation and tokenizing")
...
print("Done removing puncuation and tokenizing")
print("Expanding default stopword list and removing stopwords file")

redundant_terms = ["ship", "vessel", "time", 'crew']
...
stop_words = [i for i in stop_words] # this gets around the frozen set issue
stop_words = stop_words + bs_numbers + redundant_terms

print("tokenizing")

# I didn't stem or lem. Hypthesis is the POS will do the same thing.
df['POS'] = pos_tag_sents( df['desc_wo_punct'].apply(word_tokenize).tolist() )
